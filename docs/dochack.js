...
function toJSStr(s_1475096) {
  ...
  var result_1475097 = null;
    ...
    var res_1475170 = newSeq_1475121((s_1475096).length);
    var i_1475172 = 0;
    var j_1475174 = 0;
    L1: do {
        L2: while (true) {
        if (!(i_1475172 < (s_1475096).length)) break L2;
          ...
          i_1475172 += 1;
            ...
            var helper_1475198 = newSeq_1475121(0);
            L3: do {
                L4: while (true) {
                if (!true) break L4;
...
function newSeq_1475121(len_1475124) {
  var result_1475126 = [];

    result_1475126 = new Array(len_1475124); for (var i=0;i<len_1475124;++i) {result_1475126[i]=null;}
  return result_1475126;
